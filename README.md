...
| **Phục dựng kiến trúc** | SGM (Simple Gray Modules) & KOT/CAT STUDIOS | Bảo toàn 80% bản thiết kế gốc (Không bao gồm 4.096 bước mã hóa) |
...
- ~~✓ **PWA Ready**: Có thể cài đặt như ứng dụng di động~~ (Sử dụng bản Web)
---
